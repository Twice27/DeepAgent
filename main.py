"""
DeepAgent — Long-horizon planning agent with memory consolidation
...
class Router:
    """Cost- and latency-aware model router for DeepAgent."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="DeepAgent: Long-horizon planning agent with memory consolidation")
